...
<div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
  ...
  <div class="w-full px-6 py-64 md:px-8 lg:w-1/2">
      <h2 class="text-2xl font-semibold text-center text-gray-700 dark:text-white">MyFinance</h2>

      <p class="mt-1 text-xl text-center text-gray-600 dark:text-gray-200">Join the gang!</p>
      ...
      <div class="flex items-center justify-between mt-4">
          ...
          <a href="#" class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or signup with email</a>
      ...
      <div class="flex items-center justify-between mt-4">
          ...
          <a href="#" class="text-xs text-gray-500 dark:text-gray-400 hover:underline">Already into an alley ? Come here</a>
