<template>
    <div class="flex group items-center select-none">
        ...
        <div class="border-2 bg-gray-200 bg-opacity-50 shadow-lg h-48 w-full m-3 rounded-lg p-3 relative">
            ...
            <p class="text-center">{{book.author}} | {{book.released_year}}</p>
