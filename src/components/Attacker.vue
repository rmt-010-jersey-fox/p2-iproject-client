<template>
  <div class="attacker my-3">
    <div v-for="(attacker, i) in attackers" :key="i" class="card card-player">
      ...
      <div class="card-body">
        ...
        <div class="btn-container">
          <a @click.prevent="changePlayer(attacker.PlayerId)" href="#" class="btn btn-primary">Change</a>
          <a @click.prevent="deletePlayer(attacker.PlayerId)" href="#" class="btn btn-primary">Delete</a>
        </div>
      </div>
    </div>

    <div v-if="attackers.length < 1" class="card card-player">
      <h5 class="card-header">Attacker</h5>
      <div class="card-body">
    ...
    <div v-if="attackers.length < 2" class="card card-player">
      <h5 class="card-header">Attacker</h5>
      <div class="card-body">
        <h5 class="card-title">Kosong</h5>
    ...
    <div v-if="attackers.length < 3" class="card card-player">
      <h5 class="card-header">Attacker</h5>
      <div class="card-body">
        <h5 class="card-title">Kosong</h5>
        <p class="card-text">Kosong</p>
