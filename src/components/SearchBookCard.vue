<template>
    <div class="w-full p-2 h-72 relative mt-3 select-none">
        <div @click="addToLibrary" class="absolute right-0 top-0 bg-purple-100 p-2 rounded-full group bg-opacity-100 hover:shadow-lg transform duration-300 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 opacity-50 group-hover:opacity-100 stroke-current group-hover:text-purple-600 transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 4v12l-4-2-4 2V4M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
        </div>
        <div class="bg-gray-100 h-full rounded-xl shadow-lg">
            ...
            <div class="h-2/6 overflow-auto p-2">
                ...
                <p class="text-sm italic text-gray-700">by <span class="font-semibold">{{book.author}}</span> ( {{book.released_year}} ) </p>
            </div>
        </div>
    </div>
</template>
