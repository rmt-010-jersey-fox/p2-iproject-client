...
<style>
@import "https://fonts.googleapis.com/css2?family=Neucha&display=swap";
...
.card-row:hover {
  border-top: double blue 2px !important;
  border-bottom: double blue 2px !important;
