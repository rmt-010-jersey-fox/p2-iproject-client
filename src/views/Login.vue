      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form @submit.prevent="loginSubmit" class="form-signin">
              <div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" placeholder="Username" v-model="payload.username" autofocus>
...
:root {
  ...
  body {
    background: #fffb0000;
    background: linear-gradient(to right, #00b8e662, #fffc339c);
  }
